...
function NotFoundComponent() {
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4 pt-28 pb-16">
      <div className="max-w-md text-center">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary">KUBERR PLYWOOD</p>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary">KUBERR PLYWOOD</p>
        <h1 className="mt-4 text-xl font-semibold tracking-tight text-foreground">This page didn't load</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "KUBERR PLYWOOD" },
      { property: "og:title", content: "KUBERR PLYWOOD | Complete Interior & Furniture Material Solutions" },
      {
